...
import { 
  Shield, Brain, BarChart3, Users, ArrowRight,
  MessageSquare, Zap, Star, Sparkles, Menu, X
} from 'lucide-react';
...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      desc: "Members share honest feedback without fear.",
      color: "from-blue-500 to-indigo-600"
    },
    {
      icon: <Brain className="w-8 h-8 text-indigo-600" />,
      title: "AI-Powered Insights",
      desc: "Analyze sentiment automatically.",
      color: "from-purple-500 to-pink-600"
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-indigo-600" />,
      title: "Real-Time Dashboards",
      desc: "Track trends instantly.",
      color: "from-emerald-500 to-teal-600"
    },
    {
      icon: <Users className="w-8 h-8 text-indigo-600" />,
      title: "Collaborative Resolution",
      desc: "Solve issues together.",
  ...
  const testimonials = [
    {
      quote: "This platform helped us detect issues early.",
      author: "Sarah Chen",
      role: "Student Leader",
      avatar: "👩‍🎓"
    },
    {
      quote: "We finally act on real feedback.",
      author: "Marcus Johnson",
      role: "Administrator",
      avatar: "👨‍💼"
    },
    {
      quote: "Participation increased massively.",
  ...
  const stats = [
    { value: "98%", label: "Satisfaction", icon: <Star className="w-5 h-5 text-yellow-500" /> },
    { value: "3x", label: "Faster Resolution", icon: <Zap className="w-5 h-5 text-indigo-500" /> },
    { value: "24/7", label: "Monitoring", icon: <Brain className="w-5 h-5 text-purple-500" /> },
  ];
      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-200">
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t px-4 py-4 space-y-4 shadow-lg">
            ...
            <a href="#how-it-works" onClick={() => setMenuOpen(false)}>How It Works</a><br/>
